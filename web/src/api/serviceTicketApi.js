...
export const getTicketConversation = id => request.get(`/service-tickets/${id}/conversation`)
export const takeOverTicket = id => request.post(`/service-tickets/${id}/take-over`)
export const sendManualReply = (id, data) => request.post(`/service-tickets/${id}/manual-replies`, data)
