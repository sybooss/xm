...
const label = computed(() => {
  const labels = {
    ...
    PRODUCT_ISSUE_ALERT: '商品预警',
    CREATE_TICKET: '创建工单',
    UPDATE_TICKET: '工单更新',
    MANUAL_TAKEOVER: '人工接管',
    MANUAL_REPLY_SENT: '人工回复',
...
const tagType = computed(() => {
  if (['UP', 'SUCCESS', 'AI_ENHANCED', 'ENABLED', 'RESOLVED', 'ADMIN', 'SIGNED', 'PAID', 'DELIVERED', 'FINISHED', 'APPROVED', 'COMPLETED', 'APPROVE', 'CONFIRM', 'CREATE_TICKET', 'MANUAL_REPLY_SENT', 'USE_REPLY_DRAFT', 'SUBMIT_REVIEW', 'AI', 'USED', 'ALLOW', 'PASS', 'SUFFICIENT', '已验证'].includes(normalized.value)) return 'success'
