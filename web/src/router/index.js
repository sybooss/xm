...
const routes = [
  ...
  { path: '/showcase', name: 'showcase', component: ShowcaseView, meta: { title: '售后运营首页', adminOnly: true } },
  { path: '/dashboard', name: 'dashboard', component: DashboardView, meta: { title: '系统状态', adminOnly: true } },
  ...
  { path: '/admin/sla', name: 'admin-sla', component: SlaCenterView, meta: { title: 'SLA 跟进', adminOnly: true } },
  ...
  { path: '/logs', name: 'logs', component: LogCenterView, meta: { title: '服务日志', adminOnly: true } },
  { path: '/ai-test', name: 'ai-test', component: AiTestView, meta: { title: 'AI 质检', adminOnly: true } }
]
