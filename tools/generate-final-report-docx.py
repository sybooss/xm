...
def main():
    ...
    add_heading(doc, "2.6 日志追踪与答辩展示中心", 2)
    add_para(doc, "系统保存 AI 调用日志、知识检索日志和处理轨迹。新增 /showcase 答辩展示中心，管理员登录后默认进入该页面，可集中展示系统主题、演示顺序、8 个已实现亮点、系统状态、兜底策略和关键页面入口。")
    ...
    add_para(doc, "前端采用 Vue 3、Vite、Pinia、Vue Router、Axios 和 Element Plus。页面包括登录注册、答辩展示中心、咨询工作台、系统总览、知识库、订单管理、人工工单、日志中心和 AI 测试。答辩展示中心采用白底、轻边框、留白和清晰层级，强调克制、精致和产品感。")
    ...
    add_para(doc, "全链路接口烟测覆盖登录、注册、系统状态、AI 测试、知识库、订单售后、聊天、多轮追问、自动工单、日志和测试数据清理。浏览器烟测覆盖展示中心、咨询工作台、AI 测试、知识库、订单、工单和日志中心。")
    ...
    highlights = [
        ...
        "日志中心提供 AI 调用、检索和处理轨迹，便于证明系统可解释、可调试。",
    ...
    futures = [
        ...
        "日志中心以表格和时间线为主，后续可增加意图分布、工单趋势、AI 成功率和平均响应时长等统计看板。",
