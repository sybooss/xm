...
| 优先级 | 候选项 | 原因 | 建议版本 |
| --- | --- | --- | --- |
| P0 | AI 摘要和风险建议改造成可审计副驾驶 | 当前 `ai_summary` 仍偏占位，AI 还没有形成“建议、采纳、废弃、审计”的真实闭环 | V4.0 |
| P0 | 回复草稿和知识推荐不能直接改状态 | 下一步接入 AI 时必须继续保持人工确认，避免 AI 越权 | V4.0 |
| P1 | 售后单详情沉淀 AI 建议来源 | 管理员需要知道建议来自规则、知识库还是 AI，便于复盘 | V4.0 |
| P1 | 顾客评价和客户画像 | 工单链路已打通后，下一类高价值优化是完成顾客满意度和重复投诉视角 | V5.0 |
